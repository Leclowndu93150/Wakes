...
public class ColorPickerScreen extends Screen {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredString(font, WakesUtils.translatable("gui", "colorIntervalSlider", "title"), width / 2, 10, 0xffffff);
        if (this.showInfoText) {
            // TODO DYNAMIC TOOLTIP BACKGROUND SIZE DEPENDING ON INFO TEXT LENGTH
            TooltipRenderUtil.renderTooltipBackground(context, width - 350, height - 60, 325, 34, 0);
            context.drawWordWrap(font, WakesUtils.translatable("gui", "colorIntervalSlider", "infoText"), width - 350, height - 60, 325, 0xa8a8a8);
        }
    }
