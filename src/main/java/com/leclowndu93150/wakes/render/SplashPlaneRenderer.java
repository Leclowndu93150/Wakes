...
public class SplashPlaneRenderer {
    ...
    public static <T extends Entity> void render(T entity, SplashPlaneParticle splashPlane, RenderLevelStageEvent event, PoseStack matrices) {
        ...
        matrices.pushPose();
        splashPlane.translateMatrix(matrices, event.getCamera(), event.getPartialTick().getGameTimeDeltaTicks());
        matrices.mulPose(new Quaternionf().rotationY((float) Math.toRadians(splashPlane.lerpedYaw + 180f)));
