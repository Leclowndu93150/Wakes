...
public class WakesConfig {
    ...
    public static class Appearance {
        ...
        public Appearance(ModConfigSpec.Builder builder) {
            ...
            shaderLightPassthrough = builder
                    .comment("Brightness of wakes while a shader pack is in use. Lighting itself comes from the shader pack, so 1.0 leaves it untouched")
                    .defineInRange("shaderLightPassthrough", 1.0d, 0.0d, 1.0d);
    ...
    public static class Debug {
        ...
        public final ModConfigSpec.EnumValue<WakesRenderType> renderType;
        ...
        public Debug(ModConfigSpec.Builder builder) {
            ...
            renderType = builder
                    .defineEnum("renderType", WakesRenderType.AUTO);
        }
    }
